...
if [ ! -d "jre/zulu17.44.53-ca-fx-jre17.0.8.1-linux_x64" ]
then
  echo "Unpacking zipped jre."
  cd jre
  tar -xzvf zulu17.44.53-ca-fx-jre17.0.8.1-linux_x64.tar.gz
  cd .. && mv jre/zulu17.44.53-ca-fx-jre17.0.8.1-linux_x64/* jre
fi
