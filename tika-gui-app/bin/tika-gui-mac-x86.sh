...
if [ ! -d "jre/zulu25.28.85-ca-fx-jre25.0.0-macosx_x64" ]
then
  echo "Unpacking zipped jre."
  ditto -xk jre/zulu25.28.85-ca-fx-jre25.0.0-macosx_x64.zip jre
  mv jre/zulu25.28.85-ca-fx-jre25.0.0-macosx_x64/* jre
fi
