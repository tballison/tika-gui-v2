...
if [ ! -d "jzulu17.46.19-ca-fx-jre17.0.9-macosx_aarch64" ]
then
  echo "Unpacking zipped jre."
  ditto -xk jre/zulu17.46.19-ca-fx-jre17.0.9-macosx_aarch64.zip jre
  mv jre/zulu17.46.19-ca-fx-jre17.0.9-macosx_aarch64/* jre
fi
